...
class MiControlador extends Controller
{
    public function listar() {
        ...
        $personas = DB::select('select * from personas where DNI = ? and edad > ?', ['1A', 18]);
        //b) Usando un parámetro con nombre.
        //$personas = DB::select('select * from personas where DNI = :oscar and edad > :ed', ['oscar' => '4D','ed' => 18]);
